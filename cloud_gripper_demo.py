...
class SimulatorVelCtrl: #a communication wrapper for MuJoCo
    ...
    def init(self, modelFile, nv, action):
        ...
        for child in root:
            if child.tag == "mujoco":
                ...
                pos_table = np.array([0.475, 0.0, 0.8]) #original
    ...
    def generate_obj_table(self, obj, pos_table, size_table):
        ...
        geom0 = ET.SubElement(obj, "geom")
        geom0.set('size','{} {} {}'.format(size_table[0],size_table[1],size_table[2]))
        geom0.set('type','box')
        geom0.set('rgba','0.8 0.2 0.1 1')
        geom0.set('friction','0.25 0.005 0.0001')
        geom0.set('solimp','0.95 0.95 0.01')
        geom0.set('solref','0.01 1')
        geom0.set('condim','4')
        geom0.set('margin','0.0')
        geom0.set('pos','{} {} {}'.format(0, 0, pos_table[2]))
        ...
        geom1.set('size','{} {}'.format(0.0135,0.8))
        geom1.set('pos','{} {} {}'.format(-(size_table[0]-0.025), -(size_table[1]-0.025), 0))
        geom1.set('type','cylinder')
        geom1.set('rgba','0.8 0.2 0.1 1')
        
        geom2 = ET.SubElement(obj, "geom")
        geom2.set('size','{} {}'.format(0.0135,0.8))
        geom2.set('pos','{} {} {}'.format(-(size_table[0]-0.025), (size_table[1]-0.025), 0))
        geom2.set('type','cylinder')
        geom2.set('rgba','0.8 0.2 0.1 1')
        
        geom3 = ET.SubElement(obj, "geom")
        geom3.set('size','{} {}'.format(0.0135,0.8))
        geom3.set('pos','{} {} {}'.format((size_table[0]-0.025), -(size_table[1]-0.025), 0))
        geom3.set('type','cylinder')
        geom3.set('rgba','0.8 0.2 0.1 1')
        
        geom4 = ET.SubElement(obj, "geom")
        geom4.set('size','{} {}'.format(0.0135,0.8))
        geom4.set('pos','{} {} {}'.format((size_table[0]-0.025), (size_table[1]-0.025), 0))
        ...
        geom5 = ET.SubElement(obj, "geom")
        geom5.set('size','{} {} {}'.format(size_table[0],size_table[1],size_table[2]))
        geom5.set('type','box')
        geom5.set('rgba','0.8 0.2 0.1 1')
        geom5.set('friction','0.25 0.005 0.0001')
        geom5.set('solimp','0.95 0.95 0.01')
        geom5.set('solref','0.01 1')
        geom5.set('condim','4')
        geom5.set('margin','0.0')
        geom5.set('pos','{} {} {}'.format(0, 0, -pos_table[2]))
...
if __name__ == "__main__":
    ...
    simulator.init("cloud_gripper.xml", 7, action)
    simulator.start()